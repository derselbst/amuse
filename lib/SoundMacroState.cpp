...
template <>
constexpr SoundMacro::CmdIntrospection::Field::Type GetFieldType<SoundMacroIdDNA<amuse::Endian::Little>>() {
  return SoundMacro::CmdIntrospection::Field::Type::SoundMacroId;
}
template <>
constexpr SoundMacro::CmdIntrospection::Field::Type GetFieldType<SoundMacroStepDNA<amuse::Endian::Little>>() {
  return SoundMacro::CmdIntrospection::Field::Type::SoundMacroStep;
}
template <>
constexpr SoundMacro::CmdIntrospection::Field::Type GetFieldType<TableIdDNA<amuse::Endian::Little>>() {
  return SoundMacro::CmdIntrospection::Field::Type::TableId;
}
template <>
constexpr SoundMacro::CmdIntrospection::Field::Type GetFieldType<SampleIdDNA<amuse::Endian::Little>>() {
...
const SoundMacro::CmdIntrospection SoundMacro::CmdVibrato::Introspective = {
    ...
    {{{FIELD_HEAD(SoundMacro::CmdVibrato, levelNote), "Level Note"sv, -127, 127, 0},
     {FIELD_HEAD(SoundMacro::CmdVibrato, levelFine), "Level Fine"sv, -99, 99, 15},
...
const SoundMacro::CmdIntrospection SoundMacro::CmdPitchSweep1::Introspective = {
    ...
    {{{FIELD_HEAD(SoundMacro::CmdPitchSweep1, times), "Times"sv, 0, 127, 100},
     {FIELD_HEAD(SoundMacro::CmdPitchSweep1, add), "Add"sv, -32768, 32767, 100},
...
const SoundMacro::CmdIntrospection SoundMacro::CmdPitchSweep2::Introspective = {
    ...
    "If the time values are non-zero, this command also functions as a WAIT."sv,
    {{{FIELD_HEAD(SoundMacro::CmdPitchSweep2, times), "Times"sv, 0, 127, 100},
     {FIELD_HEAD(SoundMacro::CmdPitchSweep2, add), "Add"sv, -32768, 32767, 100},
...
const SoundMacro::CmdIntrospection SoundMacro::CmdSetPitch::Introspective = {
    ...
    {{{FIELD_HEAD(SoundMacro::CmdSetPitch, hz.val), "Hz"sv, 0, 0xffffff, 22050},
     {FIELD_HEAD(SoundMacro::CmdSetPitch, fine), "Level Fine"sv, 0, 65535, 0}}}};
...
const SoundMacro::CmdIntrospection SoundMacro::CmdSetPitchAdsr::Introspective = {
    ...
    {{{FIELD_HEAD(SoundMacro::CmdSetPitchAdsr, table), "ADSR"sv, 0, 65535, 65535},
     {FIELD_HEAD(SoundMacro::CmdSetPitchAdsr, keys), "Note range"sv, -128, 127, 0},
     {FIELD_HEAD(SoundMacro::CmdSetPitchAdsr, cents), "Cents range"sv, -99, 99, 0}}}};
...
const SoundMacro::CmdIntrospection SoundMacro::CmdScaleVolumeDLS::Introspective = {
    ...
    {{{FIELD_HEAD(SoundMacro::CmdScaleVolumeDLS, scale), "Scale"sv, 0, 16383, 4096},
     {FIELD_HEAD(SoundMacro::CmdScaleVolumeDLS, originalVol), "Original Vol"sv, 0, 1, 1}}}};
...
const SoundMacro::CmdIntrospection SoundMacro::CmdMod2Vibrange::Introspective = {
    ...
    {{{FIELD_HEAD(SoundMacro::CmdMod2Vibrange, keys), "Key range"sv, 0, 16383, 4096},
     {FIELD_HEAD(SoundMacro::CmdMod2Vibrange, cents), "Cent range"sv, 0, 1, 1}}}};
...
const SoundMacro::CmdIntrospection SoundMacro::CmdTrapEvent::Introspective = {
    ...
    {{{FIELD_HEAD(SoundMacro::CmdTrapEvent, event), "Event"sv, 0, 2, 0, {"Key Off"sv, "Sample End"sv, "Message Recv"sv}},
